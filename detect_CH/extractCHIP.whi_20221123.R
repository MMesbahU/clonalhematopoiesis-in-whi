...
### command line input:
commandLineArgs <- commandArgs(TRUE) # 1.outdir 2./path/wl.csv.gz 3./path/dnmt.csv.gz 4./path/manul.csv.gz 5./path/outprefix 6./path/all_vars.csv.gz 7.batch_name
...
names(chipVars) <- c("CHROM", "POS", "REF", "ALT", "chr_pos_ref_alt")
